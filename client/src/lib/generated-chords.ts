...
export const chordDiagrams: Record<string, ChordDiagram> = {
  ...
  'Bbsus2_barre': { name: 'Bb Suspended 2nd Barre', positions: [6, 8, 8, 1, 6, 6], fret: 1 },
  ...
  'B': { name: 'B Major', positions: ['X', 2, 4, 4, 4, 2], fret: 2 },
  'Bm': { name: 'B Minor', positions: ['X', 2, 4, 4, 3, 2], fret: 2 },
  'B7': { name: 'B Dominant 7th', positions: ['X', 2, 4, 2, 4, 2], fret: 2 },
  'Bm7': { name: 'B Minor 7th', positions: ['X', 2, 4, 2, 3, 2], fret: 2 },
  'Bmaj7': { name: 'B Major 7th', positions: ['X', 2, 4, 3, 4, 2], fret: 2 },
  'Bsus4': { name: 'B Suspended 4th', positions: ['X', 2, 4, 4, 5, 2], fret: 2 },
  'Bsus2': { name: 'B Suspended 2nd', positions: ['X', 2, 4, 4, 2, 2], fret: 2 },
  'Baug': { name: 'B Augmented', positions: ['X', 2, 1, 0, 0, 3] },
  'Bdim': { name: 'B Diminished', positions: ['X', 2, 3, 4, 3, 'X'], fret: 2 },
  'Bdim7': { name: 'B Diminished 7th', positions: ['X', 2, 3, 1, 3, 1] },
  'Badd9': { name: 'B Add9', positions: ['X', 2, 4, 6, 4, 2], fret: 2 },
  'B6': { name: 'B6', positions: ['X', 2, 4, 4, 4, 4], fret: 2 },
  'Bm6': { name: 'B Minor 6th', positions: ['X', 2, 4, 4, 3, 4], fret: 2 },
  'B9': { name: 'B9', positions: ['X', 2, 4, 2, 2, 2], fret: 2 },
  'Bmmaj7': { name: 'B Minor Major 7th', positions: ['X', 2, 4, 3, 3, 'X'], fret: 2 },
  'B7#9': { name: 'B7#9', positions: ['X', 2, 4, 2, 4, 5], fret: 2 },
  'Bmaj9': { name: 'B Major 9th', positions: ['X', 2, 1, 3, 2, 'X'] },
  'Bm9': { name: 'B Minor 9th', positions: ['X', 2, 4, 2, 2, 4], fret: 2 },
  'B7b9': { name: 'B7b9', positions: ['X', 2, 1, 2, 1, 'X'] },
  'B7#5': { name: 'B7#5', positions: ['X', 2, 5, 2, 4, 'X'], fret: 2 },
  'B7b5': { name: 'B7b5', positions: ['X', 2, 3, 2, 4, 'X'], fret: 2 },
  'B11': { name: 'B11', positions: ['X', 2, 2, 2, 2, 2], fret: 2 },
  'Bm11': { name: 'B Minor 11th', positions: ['X', 2, 2, 2, 2, 4], fret: 2 },
  'B13': { name: 'B13', positions: ['X', 2, 6, 2, 4, 4], fret: 2 },
  'Bm13': { name: 'B Minor 13th', positions: ['X', 2, 4, 2, 4, 6], fret: 2 },
  ...
  'Bsus2_barre': { name: 'B Suspended 2nd Barre', positions: [7, 9, 9, 2, 7, 7], fret: 2 },
  ...
  'Cm': { name: 'C Minor', positions: ['X', 3, 5, 5, 4, 3], fret: 3 },
  'C7': { name: 'C Dominant 7th', positions: ['X', 3, 2, 3, 1, 0] },
  'Cm7': { name: 'C Minor 7th', positions: ['X', 3, 5, 3, 4, 3], fret: 3 },
  ...
  'Cdim': { name: 'C Diminished', positions: ['X', 3, 4, 5, 4, 'X'], fret: 3 },
  'Cdim7': { name: 'C Diminished 7th', positions: ['X', 3, 4, 2, 4, 'X'], fret: 2 },
  ...
  'Cmmaj7': { name: 'C Minor Major 7th', positions: ['X', 3, 5, 4, 4, 3], fret: 3 },
  'C7#9': { name: 'C7#9', positions: ['X', 3, 2, 3, 4, 'X'], fret: 2 },
  'Cmaj9': { name: 'C Major 9th', positions: ['X', 3, 2, 4, 3, 'X'], fret: 2 },
  'Cm9': { name: 'C Minor 9th', positions: ['X', 3, 1, 3, 3, 3] },
  'C7b9': { name: 'C7b9', positions: ['X', 3, 2, 3, 2, 'X'], fret: 2 },
  'C7#5': { name: 'C7#5', positions: ['X', 3, 4, 3, 5, 'X'], fret: 3 },
  'C7b5': { name: 'C7b5', positions: ['X', 3, 4, 3, 4, 'X'], fret: 3 },
  'C11': { name: 'C11', positions: ['X', 3, 3, 3, 3, 3], fret: 3 },
  'Cm11': { name: 'C Minor 11th', positions: ['X', 3, 3, 3, 3, 5], fret: 3 },
  'C13': { name: 'C13', positions: ['X', 3, 5, 3, 5, 5], fret: 3 },
  'Cm13': { name: 'C Minor 13th', positions: ['X', 3, 5, 3, 5, 7], fret: 3 },
  'C_barre': { name: 'C Major Barre', positions: [8, 10, 10, 9, 8, 8], fret: 8 },
  'Cm_barre': { name: 'C Minor Barre', positions: [3, 5, 5, 3, 3, 3], fret: 3 },
  'C7_barre': { name: 'C Dominant 7th Barre', positions: [8, 9, 8, 9, 8, 8], fret: 8 },
  'Cm7_barre': { name: 'C Minor 7th Barre', positions: [3, 5, 3, 3, 3, 3], fret: 3 },
  'Cmaj7_barre': { name: 'C Major 7th Barre', positions: [8, 9, 9, 9, 8, 8], fret: 8 },
  'Csus4_barre': { name: 'C Suspended 4th Barre', positions: [8, 10, 10, 10, 8, 8], fret: 8 },
  'Csus2_barre': { name: 'C Suspended 2nd Barre', positions: [8, 10, 3, 9, 8, 8], fret: 3 },
  ...
  'Cadd9_barre': { name: 'C Add9 Barre', positions: [8, 9, 8, 9, 8, 10], fret: 8 },
  'C6_barre': { name: 'C6 Barre', positions: [8, 9, 8, 9, 10, 8], fret: 8 },
  'Cm6_barre': { name: 'C Minor 6th Barre', positions: [8, 9, 8, 7, 9, 8], fret: 7 },
  'C9_barre': { name: 'C9 Barre', positions: [8, 9, 8, 9, 10, 10], fret: 8 },
  'C7#9_barre': { name: 'C7#9 Barre', positions: [8, 9, 8, 9, 10, 11], fret: 8 },
  'C#': { name: 'C# Major', positions: ['X', 4, 6, 6, 6, 4], fret: 4 },
  'C#m': { name: 'C# Minor', positions: ['X', 4, 6, 6, 5, 4], fret: 4 },
  'C#7': { name: 'C# Dominant 7th', positions: ['X', 4, 6, 4, 6, 4], fret: 4 },
  'C#m7': { name: 'C# Minor 7th', positions: ['X', 4, 6, 4, 5, 4], fret: 4 },
  'C#maj7': { name: 'C# Major 7th', positions: ['X', 4, 6, 5, 6, 4], fret: 4 },
  'C#sus4': { name: 'C# Suspended 4th', positions: ['X', 4, 6, 6, 7, 4], fret: 4 },
  'C#sus2': { name: 'C# Suspended 2nd', positions: ['X', 4, 6, 6, 4, 4], fret: 4 },
  'C#aug': { name: 'C# Augmented', positions: ['X', 4, 3, 2, 2, 'X'], fret: 2 },
  'C#dim': { name: 'C# Diminished', positions: ['X', 4, 5, 6, 5, 'X'], fret: 4 },
  'C#dim7': { name: 'C# Diminished 7th', positions: ['X', 4, 5, 3, 5, 3], fret: 3 },
  'C#add9': { name: 'C# Add9', positions: ['X', 4, 6, 8, 6, 4], fret: 4 },
  'C#6': { name: 'C#6', positions: ['X', 4, 6, 6, 6, 6], fret: 4 },
  'C#m6': { name: 'C# Minor 6th', positions: ['X', 4, 6, 6, 5, 6], fret: 4 },
  'C#9': { name: 'C#9', positions: ['X', 4, 3, 4, 4, 4], fret: 3 },
  'C#mmaj7': { name: 'C# Minor Major 7th', positions: ['X', 4, 6, 5, 5, 4], fret: 4 },
  'C#7#9': { name: 'C#7#9', positions: ['X', 4, 6, 4, 6, 7], fret: 4 },
  'C#maj9': { name: 'C# Major 9th', positions: ['X', 4, 1, 3, 3, 'X'] },
  'C#m9': { name: 'C# Minor 9th', positions: ['X', 4, 2, 4, 4, 4], fret: 2 },
  'C#7b9': { name: 'C#7b9', positions: ['X', 4, 3, 4, 3, 'X'], fret: 3 },
  'C#7#5': { name: 'C#7#5', positions: ['X', 4, 7, 4, 6, 'X'], fret: 4 },
  'C#7b5': { name: 'C#7b5', positions: ['X', 4, 5, 4, 5, 'X'], fret: 4 },
  'C#11': { name: 'C#11', positions: ['X', 4, 4, 4, 4, 4], fret: 4 },
  'C#m11': { name: 'C# Minor 11th', positions: ['X', 4, 4, 4, 4, 6], fret: 4 },
  'C#13': { name: 'C#13', positions: ['X', 4, 6, 4, 6, 6], fret: 4 },
  'C#m13': { name: 'C# Minor 13th', positions: ['X', 4, 6, 4, 6, 8], fret: 4 },
  'C#_barre': { name: 'C# Major Barre', positions: [9, 1, 1, 1, 1, 9], fret: 1 },
  'C#m_barre': { name: 'C# Minor Barre', positions: [9, 1, 1, 1, 1, 8], fret: 1 },
  'C#7_barre': { name: 'C# Dominant 7th Barre', positions: [9, 11, 9, 'X', 10, 'X'], fret: 9 },
  'C#m7_barre': { name: 'C# Minor 7th Barre', positions: [9, 11, 8, 'X', 10, 'X'], fret: 8 },
  'C#maj7_barre': { name: 'C# Major 7th Barre', positions: [9, 11, 10, 'X', 10, 'X'], fret: 9 },
  'C#sus4_barre': { name: 'C# Suspended 4th Barre', positions: [9, 11, 11, 'X', 11, 'X'], fret: 9 },
  'C#sus2_barre': { name: 'C# Suspended 2nd Barre', positions: [9, 11, 4, 'X', 10, 'X'], fret: 4 },
  ...
  'C#add9_barre': { name: 'C# Add9 Barre', positions: [9, 11, 9, 'X', 10, 11], fret: 9 },
  'C#6_barre': { name: 'C#6 Barre', positions: [9, 11, 9, 'X', 10, 'X'], fret: 9 },
  'C#m6_barre': { name: 'C# Minor 6th Barre', positions: [9, 11, 9, 'X', 10, 'X'], fret: 9 },
  'C#9_barre': { name: 'C#9 Barre', positions: [9, 11, 9, 'X', 10, 'X'], fret: 9 },
  'C#7#9_barre': { name: 'C#7#9 Barre', positions: [9, 11, 9, 'X', 10, 'X'], fret: 9 },
  ...
  'D11': { name: 'D11', positions: ['X', 'X', 3, 3, 3, 3], fret: 3 },
  'Dm11': { name: 'D Minor 11th', positions: ['X', 'X', 3, 3, 3, 5], fret: 3 },
  'D13': { name: 'D13', positions: ['X', 'X', 3, 5, 3, 5], fret: 3 },
  'Dm13': { name: 'D Minor 13th', positions: ['X', 'X', 3, 5, 3, 7], fret: 3 },
  ...
  'Eb': { name: 'Eb Major', positions: ['X', 6, 8, 8, 8, 6], fret: 6 },
  'Ebm': { name: 'Eb Minor', positions: ['X', 6, 8, 8, 7, 6], fret: 6 },
  'Eb7': { name: 'Eb Dominant 7th', positions: ['X', 6, 8, 6, 8, 6], fret: 6 },
  'Ebm7': { name: 'Eb Minor 7th', positions: ['X', 6, 8, 6, 7, 6], fret: 6 },
  'Ebmaj7': { name: 'Eb Major 7th', positions: ['X', 6, 8, 7, 8, 6], fret: 6 },
  'Ebsus4': { name: 'Eb Suspended 4th', positions: ['X', 6, 8, 8, 9, 6], fret: 6 },
  'Ebsus2': { name: 'Eb Suspended 2nd', positions: ['X', 6, 8, 8, 6, 6], fret: 6 },
  'Ebaug': { name: 'Eb Augmented', positions: ['X', 6, 5, 4, 4, 'X'], fret: 4 },
  'Ebdim': { name: 'Eb Diminished', positions: ['X', 6, 7, 5, 6, 'X'], fret: 5 },
  'Ebdim7': { name: 'Eb Diminished 7th', positions: ['X', 6, 7, 5, 7, 5], fret: 5 },
  'Ebadd9': { name: 'Eb Add9', positions: ['X', 6, 8, 8, 8, 8], fret: 6 },
  'Eb6': { name: 'Eb6', positions: ['X', 6, 8, 8, 8, 8], fret: 6 },
  'Ebm6': { name: 'Eb Minor 6th', positions: ['X', 6, 8, 8, 7, 8], fret: 6 },
  'Eb9': { name: 'Eb9', positions: ['X', 6, 5, 6, 6, 6], fret: 5 },
  'Ebmmaj7': { name: 'Eb Minor Major 7th', positions: ['X', 6, 8, 7, 7, 6], fret: 6 },
  'Eb7#9': { name: 'Eb7#9', positions: ['X', 6, 8, 6, 8, 9], fret: 6 },
  'Ebmaj9': { name: 'Eb Major 9th', positions: ['X', 6, 5, 7, 8, 'X'], fret: 5 },
  'Ebm9': { name: 'Eb Minor 9th', positions: ['X', 6, 4, 6, 6, 6], fret: 4 },
  'Eb7b9': { name: 'Eb7b9', positions: ['X', 6, 5, 6, 5, 'X'], fret: 5 },
  'Eb7#5': { name: 'Eb7#5', positions: ['X', 6, 9, 6, 8, 'X'], fret: 6 },
  'Eb7b5': { name: 'Eb7b5', positions: ['X', 6, 7, 6, 7, 'X'], fret: 6 },
  'Eb11': { name: 'Eb11', positions: ['X', 6, 6, 6, 6, 6], fret: 6 },
  'Ebm11': { name: 'Eb Minor 11th', positions: ['X', 6, 6, 6, 6, 8], fret: 6 },
  'Eb13': { name: 'Eb13', positions: ['X', 6, 8, 6, 8, 8], fret: 6 },
  'Ebm13': { name: 'Eb Minor 13th', positions: ['X', 6, 8, 6, 8, 10], fret: 6 },
  'Eb_barre': { name: 'Eb Major Barre', positions: [10, 12, 12, 12, 11, 10], fret: 10 },
  'Ebm_barre': { name: 'Eb Minor Barre', positions: [10, 12, 12, 12, 10, 10], fret: 10 },
  'Eb7_barre': { name: 'Eb Dominant 7th Barre', positions: [10, 12, 10, 12, 11, 10], fret: 10 },
  'Ebm7_barre': { name: 'Eb Minor 7th Barre', positions: [10, 12, 10, 12, 10, 10], fret: 10 },
  'Ebmaj7_barre': { name: 'Eb Major 7th Barre', positions: [10, 12, 12, 'X', 12, 11], fret: 10 },
  'Ebsus4_barre': { name: 'Eb Suspended 4th Barre', positions: [10, 12, 12, 12, 12, 10], fret: 10 },
  'Ebsus2_barre': { name: 'Eb Suspended 2nd Barre', positions: [10, 12, 12, 5, 11, 10], fret: 5 },
  'Ebaug_barre': { name: 'Eb Augmented Barre', positions: ['X', 'X', 11, 'X', 10, 'X'], fret: 10 },
  'Ebdim_barre': { name: 'Eb Diminished Barre', positions: ['X', 'X', 11, 'X', 9, 'X'], fret: 9 },
  'Ebdim7_barre': { name: 'Eb Diminished 7th Barre', positions: ['X', 'X', 11, 'X', 9, 'X'], fret: 9 },
  'Ebadd9_barre': { name: 'Eb Add9 Barre', positions: [10, 12, 10, 12, 11, 12], fret: 10 },
  'Eb6_barre': { name: 'Eb6 Barre', positions: [10, 12, 10, 12, 12, 12], fret: 10 },
  'Ebm6_barre': { name: 'Eb Minor 6th Barre', positions: [10, 12, 10, 12, 10, 12], fret: 10 },
  'Eb9_barre': { name: 'Eb9 Barre', positions: [10, 12, 10, 12, 12, 12], fret: 10 },
  'Eb7#9_barre': { name: 'Eb7#9 Barre', positions: [10, 12, 10, 12, 'X', 12], fret: 10 },
  ...
  'Edim': { name: 'E Diminished', positions: ['X', 'X', 2, 3, 2, 3], fret: 2 },
  ...
  'E7#9': { name: 'E7#9', positions: ['X', 'X', 2, 4, 3, 5], fret: 2 },
  ...
  'Esus2_barre': { name: 'E Suspended 2nd Barre', positions: ['X', 7, 9, 2, 9, 7], fret: 2 },
  ...
  'E6_barre': { name: 'E6 Barre', positions: ['X', 7, 9, 9, 7, 9], fret: 7 },
  'Em6_barre': { name: 'E Minor 6th Barre', positions: ['X', 7, 9, 9, 7, 8], fret: 7 },
  'E9_barre': { name: 'E9 Barre', positions: ['X', 7, 9, 9, 7, 10], fret: 7 },
  'E7#9_barre': { name: 'E7#9 Barre', positions: ['X', 7, 9, 9, 7, 11], fret: 7 },
  'F': { name: 'F Major', positions: [1, 3, 3, 2, 1, 1] },
  'Fm': { name: 'F Minor', positions: [1, 3, 3, 1, 1, 1] },
  'F7': { name: 'F Dominant 7th', positions: [1, 3, 1, 2, 1, 1] },
  'Fm7': { name: 'F Minor 7th', positions: [1, 3, 1, 1, 1, 1] },
  'Fmaj7': { name: 'F Major 7th', positions: [1, 3, 2, 2, 1, 1] },
  'Fsus4': { name: 'F Suspended 4th', positions: [1, 3, 3, 3, 1, 1] },
  'Fsus2': { name: 'F Suspended 2nd', positions: [1, 0, 3, 0, 1, 1] },
  'Faug': { name: 'F Augmented', positions: [1, 0, 3, 2, 2, 1] },
  'Fdim': { name: 'F Diminished', positions: [1, 2, 3, 1, 3, 'X'] },
  'Fdim7': { name: 'F Diminished 7th', positions: [1, 2, 0, 1, 0, 1] },
  'Fadd9': { name: 'F Add9', positions: [1, 0, 3, 2, 1, 3] },
  'F6': { name: 'F6', positions: [1, 3, 3, 2, 3, 1] },
  'Fm6': { name: 'F Minor 6th', positions: [1, 3, 3, 1, 3, 1] },
  'F9': { name: 'F9', positions: [1, 3, 1, 2, 1, 3] },
  'Fmmaj7': { name: 'F Minor Major 7th', positions: [1, 3, 2, 1, 1, 1] },
  'F7#9': { name: 'F7#9', positions: [1, 3, 1, 2, 1, 4] },
  'Fmaj9': { name: 'F Major 9th', positions: [1, 3, 0, 2, 1, 0] },
  'Fm9': { name: 'F Minor 9th', positions: [1, 3, 1, 1, 1, 3] },
  'F7b9': { name: 'F7b9', positions: [1, 3, 1, 2, 1, 2] },
  'F7#5': { name: 'F7#5', positions: [1, 4, 1, 3, 1, 2] },
  'F7b5': { name: 'F7b5', positions: [1, 'X', 1, 2, 0, 1] },
  'F11': { name: 'F11', positions: [1, 3, 3, 3, 3, 3] },
  'Fm11': { name: 'F Minor 11th', positions: [1, 3, 3, 3, 3, 5] },
  'F13': { name: 'F13', positions: [1, 5, 3, 3, 5, 5] },
  'Fm13': { name: 'F Minor 13th', positions: [1, 5, 3, 3, 5, 7] },
  'F_barre': { name: 'F Major Barre', positions: ['X', 8, 10, 10, 'X', 10], fret: 8 },
  'Fm_barre': { name: 'F Minor Barre', positions: ['X', 8, 10, 10, 9, 8], fret: 8 },
  'F7_barre': { name: 'F Dominant 7th Barre', positions: ['X', 8, 10, 8, 'X', 10], fret: 8 },
  'Fm7_barre': { name: 'F Minor 7th Barre', positions: ['X', 8, 10, 8, 9, 8], fret: 8 },
  'Fmaj7_barre': { name: 'F Major 7th Barre', positions: ['X', 8, 10, 9, 'X', 10], fret: 8 },
  'Fsus4_barre': { name: 'F Suspended 4th Barre', positions: ['X', 8, 10, 10, 'X', 11], fret: 8 },
  'Fsus2_barre': { name: 'F Suspended 2nd Barre', positions: ['X', 8, 10, 5, 'X', 10], fret: 5 },
  ...
  'Fadd9_barre': { name: 'F Add9 Barre', positions: ['X', 8, 10, 8, 'X', 10], fret: 8 },
  'F6_barre': { name: 'F6 Barre', positions: ['X', 8, 10, 8, 'X', 10], fret: 8 },
  'Fm6_barre': { name: 'F Minor 6th Barre', positions: ['X', 8, 10, 8, 'X', 9], fret: 8 },
  'F9_barre': { name: 'F9 Barre', positions: ['X', 8, 10, 8, 'X', 10], fret: 8 },
  'F7#9_barre': { name: 'F7#9 Barre', positions: ['X', 8, 10, 8, 'X', 10], fret: 8 },
  ...
  'F#sus2': { name: 'F# Suspended 2nd', positions: [2, 4, 4, 1, 2, 2] },
  ...
  'F#maj9': { name: 'F# Major 9th', positions: [2, 4, 1, 2, 'X', 'X'] },
  ...
  'F#7b5': { name: 'F#7b5', positions: [2, 'X', 2, 3, 1, 'X'] },
  ...
  'F#_barre': { name: 'F# Major Barre', positions: [10, 11, 11, 11, 10, 9], fret: 9 },
  'F#m_barre': { name: 'F# Minor Barre', positions: [10, 11, 11, 10, 'X', 10], fret: 10 },
  'F#7_barre': { name: 'F# Dominant 7th Barre', positions: [10, 11, 9, 'X', 11, 'X'], fret: 9 },
  'F#m7_barre': { name: 'F# Minor 7th Barre', positions: [10, 11, 9, 'X', 10, 'X'], fret: 9 },
  'F#maj7_barre': { name: 'F# Major 7th Barre', positions: [10, 11, 10, 'X', 11, 'X'], fret: 10 },
  'F#sus4_barre': { name: 'F# Suspended 4th Barre', positions: [10, 11, 11, 'X', 12, 'X'], fret: 10 },
  'F#sus2_barre': { name: 'F# Suspended 2nd Barre', positions: [10, 11, 11, 6, 'X', 10], fret: 6 },
  ...
  'F#add9_barre': { name: 'F# Add9 Barre', positions: [10, 11, 9, 'X', 10, 11], fret: 9 },
  'F#6_barre': { name: 'F#6 Barre', positions: [10, 11, 9, 'X', 10, 'X'], fret: 9 },
  'F#m6_barre': { name: 'F# Minor 6th Barre', positions: [10, 11, 9, 'X', 10, 'X'], fret: 9 },
  'F#9_barre': { name: 'F#9 Barre', positions: [10, 11, 9, 'X', 10, 'X'], fret: 9 },
  'F#7#9_barre': { name: 'F#7#9 Barre', positions: [10, 11, 9, 'X', 10, 'X'], fret: 9 },
  ...
  'Gdim': { name: 'G Diminished', positions: [3, 'X', 2, 3, 2, 'X'], fret: 2 },
  ...
  'G7#9': { name: 'G7#9', positions: [3, 'X', 3, 4, 4, 'X'], fret: 3 },
  'Gmaj9': { name: 'G Major 9th', positions: [3, 'X', 0, 0, 0, 2] },
  'Gm9': { name: 'G Minor 9th', positions: [3, 5, 3, 3, 3, 5], fret: 3 },
  'G7b9': { name: 'G7b9', positions: [3, 'X', 3, 4, 3, 'X'], fret: 3 },
  'G7#5': { name: 'G7#5', positions: [3, 'X', 3, 4, 2, 'X'], fret: 2 },
  'G7b5': { name: 'G7b5', positions: [3, 'X', 2, 3, 1, 'X'] },
  'G11': { name: 'G11', positions: [3, 'X', 3, 3, 3, 3], fret: 3 },
  'Gm11': { name: 'G Minor 11th', positions: [3, 'X', 3, 3, 3, 5], fret: 3 },
  'G13': { name: 'G13', positions: [3, 'X', 5, 3, 5, 5], fret: 3 },
  'Gm13': { name: 'G Minor 13th', positions: [3, 'X', 5, 3, 5, 7], fret: 3 },
  'G_barre': { name: 'G Major Barre', positions: ['X', 10, 12, 12, 'X', 12], fret: 10 },
  'Gm_barre': { name: 'G Minor Barre', positions: ['X', 10, 12, 12, 'X', 11], fret: 10 },
  'G7_barre': { name: 'G Dominant 7th Barre', positions: ['X', 10, 12, 10, 'X', 12], fret: 10 },
  'Gm7_barre': { name: 'G Minor 7th Barre', positions: ['X', 10, 12, 10, 'X', 11], fret: 10 },
  'Gmaj7_barre': { name: 'G Major 7th Barre', positions: ['X', 10, 12, 12, 'X', 11], fret: 10 },
  'Gsus4_barre': { name: 'G Suspended 4th Barre', positions: ['X', 10, 12, 12, 'X', 13], fret: 10 },
  'Gsus2_barre': { name: 'G Suspended 2nd Barre', positions: ['X', 10, 12, 7, 'X', 12], fret: 7 },
  'Gaug_barre': { name: 'G Augmented Barre', positions: ['X', 'X', 11, 'X', 10, 'X'], fret: 10 },
  'Gdim_barre': { name: 'G Diminished Barre', positions: ['X', 'X', 11, 'X', 9, 'X'], fret: 9 },
  'Gdim7_barre': { name: 'G Diminished 7th Barre', positions: ['X', 'X', 11, 'X', 9, 'X'], fret: 9 },
  'Gadd9_barre': { name: 'G Add9 Barre', positions: ['X', 10, 12, 10, 'X', 12], fret: 10 },
  'G6_barre': { name: 'G6 Barre', positions: ['X', 10, 12, 10, 'X', 12], fret: 10 },
  'Gm6_barre': { name: 'G Minor 6th Barre', positions: ['X', 10, 12, 10, 'X', 11], fret: 10 },
  'G9_barre': { name: 'G9 Barre', positions: ['X', 10, 12, 10, 'X', 12], fret: 10 },
  'G7#9_barre': { name: 'G7#9 Barre', positions: ['X', 10, 12, 10, 'X', 12], fret: 10 },
  ...
  'Absus2': { name: 'Ab Suspended 2nd', positions: [4, 6, 6, 3, 4, 4], fret: 3 },
  'Abaug': { name: 'Ab Augmented', positions: [4, 'X', 2, 1, 1, 0] },
  'Abdim': { name: 'Ab Diminished', positions: [4, 'X', 5, 4, 5, 'X'], fret: 4 },
  'Abdim7': { name: 'Ab Diminished 7th', positions: [4, 'X', 3, 4, 3, 'X'], fret: 3 },
  ...
  'Abmaj9': { name: 'Ab Major 9th', positions: [4, 'X', 3, 1, 4, 'X'] },
  ...
  'Ab7b5': { name: 'Ab7b5', positions: [4, 'X', 4, 5, 4, 'X'], fret: 4 },
  'Ab11': { name: 'Ab11', positions: [4, 6, 4, 4, 4, 4], fret: 4 },
  'Abm11': { name: 'Ab Minor 11th', positions: [4, 6, 4, 4, 4, 6], fret: 4 },
  'Ab13': { name: 'Ab13', positions: [4, 8, 4, 4, 6, 6], fret: 4 },
  'Abm13': { name: 'Ab Minor 13th', positions: [4, 8, 4, 4, 6, 8], fret: 4 },
  ...
  'Absus2_barre': { name: 'Ab Suspended 2nd Barre', positions: [4, 6, 6, 3, 4, 4], fret: 3 },
  ...
  'Abdim7_barre': { name: 'Ab Diminished 7th Barre', positions: [4, 'X', 5, 4, 6, 'X'], fret: 4 },
